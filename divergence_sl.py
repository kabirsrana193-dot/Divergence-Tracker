...
NIFTY_200_SYMBOLS = [
    ...
    'ASTRAL.NS', 'CANBK.NS', 'CGPOWER.NS', 'CHOLAHLDNG.NS', 'CRISIL.NS',
    'DELHIVERY.NS', 'LODHA.NS', 'GUJGASLTD.NS', 'HINDPETRO.NS', 'INDUSTOWER.NS',
    'JUBLFOOD.NS', 'KANSAINER.NS', 'KEI.NS', 'LTF.NS', 'MAXHEALTH.NS',
    'MFSL.NS', 'OFSS.NS', 'PAYTM.NS', 'PHOENIX.NS', 'POLICYBZR.NS',
    'ZYDUSWELL.NS', 'PEL.NS', 'PGHH.NS', 'PIDILITIND.NS', 'PVR.NS',
    'RAMCOCEM.NS', 'SAIL.NS', 'SBILIFE.NS', 'SHREECEM.NS', 'SOLARINDS.NS',
    'SUNTV.NS', 'SUPREMEIND.NS', 'TORNTPOWER.NS', 'TRENT.NS', 'TVSMOTOR.NS',
    'UBL.NS', 'ULTRACEMCO.NS', 'UPL.NS', 'VEDL.NS', 'WHIRLPOOL.NS'
]
